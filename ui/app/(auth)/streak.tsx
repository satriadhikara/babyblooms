...
const StreakCelebration = ({
  ...
  return (
    <SafeAreaView
      style={{ flex: 1, backgroundColor: "#faf9f6", paddingHorizontal: 24 }}
    >
      ...
      >
        ...
        >
          Terus lacak kehamilanmu untuk mengetahui perkembangannya dan klik
          gejala untuk mempelajari lebih lanjut dengan BloomsAI.
        </ThemedText>
