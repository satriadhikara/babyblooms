...
const NameNest = () => {
  const [messages, setMessages] = useState<{ text: string; sender: string }[]>([
    ...
    { text: "Berikan nama untuk bayimu!", sender: "bot" },
  ]);
        ...
        <View style={styles.messageContent}>
          {isFirstBotMessage && (
            <View style={styles.botIconContainer}>
              <Image
                source={require("../../assets/images/bayiAI.png")}
          ...
          >
            {isFirstBotMessage && <Text style={styles.botName}>NameNest</Text>}
            <View
              style={[
      ...
      <SafeAreaView style={styles.container}>
        <View style={styles.header}>
          <AntDesign
            ...
            onPress={handleBack}
          />
          <ThemedText type="titleMedium">NameNest</ThemedText>
          <View style={{ width: 24 }} />
        </View>
        <FlatList
          data={
